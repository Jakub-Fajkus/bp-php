...
\todo{zminit se o experimentech 2 roboti na primce a spirale!!!!!}
...
První model, zvaný trojnožka, je vidět na obrázku \todo{obrazek robota trojnozka}.
...
Druhý robot, zvaný mravenec, je vidět na obrázku \todo{obrazek robota mravenec}.
...
Pro experimenty se spirálovou trajektori je celý genotyp pro účely křížení rozdělen na 3 části, které korespondují s podprogramy, viz obrázek
\ref{fig:genotyp}.

\begin{figure}[h]
    \centering
    {\includegraphics[width=30em]{obrazky-figures/genotyp.pdf}}
    \caption{
...
\begin{figure}[h]
    \centering
    {\includegraphics[width=35em]{obrazky-figures/krizeni_podprogramu.pdf}}
    \caption{
...
\subsection{Mutace}
moje mutace s pravdepodobnosti 1 a pravdepodobnostmi zmeny jednotlivych prvku - random resetting

\subsection{Ukončovací podmínka}
- nastaveny pocet generaci = 300
...
\chapter{Experimenty}
\todo{uvest delku pouziteho genomu pro kazdy experiment}
