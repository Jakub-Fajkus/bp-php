...
\begin{algorithm}[H]
    ...
    \While{(není splněna ukončující podmínka)}{
        ...
        mutuj potomky\;
        vyhodnoť nové kandidátní řešení\;
...
%Pokud je selekční tlak velký, jsou nejlepší jedinci vybíráni častěji a tak může dojít ke ztrátě diverzity v populaci a k předčasné konvergenci algoritmu.
%Dochází tedy k častějšímu uváznutí v lokálním minimu.
%Naopak, pokud je selekční tlak malý, jsou často vybíráni i horší jedinci, a to může mít za následek velmi pomalou konvergenci algoritmu.
...
Jednobodové křížení bylo původně představeno J. H. Hollandem v \todo{odkaz} a jeho funkce je následující.
