...
\todo{todo pridat "Zdroj: [8]" k hornbymu}
\todo{pridat znimku do uvodu, nebo abstraktu, o tom, ze mravenec umi chodit po nezname trajektorii}
\chapter{Úvod}
Vygenerovano: \DTMnow
...
\todo{umistit obrazky pod sebe na jednu stranu: 3 sloupce, 2 radky}
...
\todo{zduvodnit velkou variaci v hodnotach fitness}
...
\section{Spirála}
\todo{napsat, ze bez podprogramu a input hodnot to neslo}
\todo{napsat, ze trojnozka casto upadne a proto je vysoke cislo jedincu, kteri maji nulu!}
\todo{napsat, ze model zacinal uprostred}

\subsection{Model trojnožky na spirále}
\todo{dobra trajektorie}
\todo{spatna trajektorie}
...
Poslední trajektorii, která definovala čtverec~(obrázek~\ref{fig:mravenec_testovaci_trajektorie3}), toto řešení side dokončilo, ale velmi neefektivním způsobem.
