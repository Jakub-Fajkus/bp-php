...
G. Hornby touto metodou vyvinul množstí robotů, z nichž některé i skutečně vyrobil, viz obrázek
...
\begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=.7\linewidth]{obrazky/hornby_model_1_simulace.png}
        \caption{Robot v simulátoru}
        \label{fig:hornby_roboti_simulace}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=.7\linewidth]{obrazky/hornby_model_1_real.png}
