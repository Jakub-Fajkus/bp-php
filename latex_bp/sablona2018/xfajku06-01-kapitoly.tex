...
Simulátor Mujoco funguje jako \todo{dynamicky linkovana knihovna} napsaná v jazyce C.
...
Uživatel má plnou kontrolu nad během simulace, a to tím, že volá knihovní funkci \todo{mj\_step()}, která v simulaci pokročí definovaným časem.
...
Ve zjednodušené formě je program znázorněn na \todo{obrázek s algoritmem simulatoru}.
