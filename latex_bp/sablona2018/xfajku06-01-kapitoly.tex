...
V~sekci~\ref{sec:experiment_primka} je představen experiment na s přímkovou trajektoríí pro oba modely, který je následován experimentem se spirálovou trajektoríí v sekci~\ref{sec:experiment_spirala}, rovněž pro oba modely.
