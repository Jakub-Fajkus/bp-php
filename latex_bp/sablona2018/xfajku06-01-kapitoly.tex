...
Pro tyto potřeby byl použit zjednodušený koncept LGP, který bude blíže představen v sekci~\ref{sec:realizace_rizeni_modelu}, a simulátor MuJoCo\footnote{Web: \url{http://www.mujoco.org/index.html}}.

\todo{popis MuJoCo na 1-2 odstavce - obecne o simulatoru, jak se definuji modely, mozna dat ukazku meho modelu}
