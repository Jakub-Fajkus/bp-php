...
V této kapitole je pro každý experiment prezentován graf vývoje průměrné a maximální fitness hodnoty v populaci a také \todo{bar and whisker} pro nejlepší evoluční běh.
Veškeré další grafy, které byly vygenerovány, je možné nalézt v přílohách na přiloženém médiu.
\todo{mozna dat k experimentum 3-4 historgramy rozlozeni fitness? zacatek, a pak po ctvrtinach?}
