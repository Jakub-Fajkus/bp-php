...
\begin{figure}[h]
    \begin{minipage}[c]{0.48\linewidth}
        ...
        \caption{Histogram celkového počtu jedinců ve všech bězích mravence na přímce ve 30. generaci}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{0.48\linewidth}
...
\begin{figure}[h]
    ...
    \begin{minipage}[c]{0.48\linewidth}
        ...
        \caption{Histogram celkového počtu jedinců ve všech bězích mravence na přímce ve 120. generaci}
    \end{minipage}
    %
\end{figure}
...
\todo{napsat, ze trojnozka casto upadne a proto je vysoke cislo jedincu, kteri mji nulu!}
