...
\projectinfo{
  ...
  keywords.cs={Evolutionary computation, Lineární Genetické Programování, Robotika}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={Evolutionary computation, Linear Genetic Programming, Robotics}, % klíčová slova v anglickém jazyce / keywords in english
  % Abstrakt / Abstract
  abstract.cs={
...
Účinnost softwarového řízení je experimentálně doložena s použitím dvou robotických modelů na dvou trajektoriích.
  ...
  abstract.en={
The aim of this work is to implement a framework which will be used to find a computer program that will control a robotic model in a simulation.
The model is supposed to move along specified trajectory.
For this purpose a technique of simplified Linear Genetic Programming is used.
The MuJoCo simulator is used to simulate the robotic model.
The used approach is evaluated by performing experiments with two robotic models and two trajectories.
