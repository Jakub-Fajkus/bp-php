...
Because of that programs exhibit some degree of expected behavior in environments that they were not exposed before.
}
...
\begin{figure}[t]
	\centering
	{\includegraphics[height=19em]{reference_direction_angles.png}}
	\caption{
...
%todo: nakreslit obrazek interpretu -> registry s konstantami, registry se vstupy, registry pro vystup,...
%--------------------------------------------------------
%--------------------------------------------------------
%--------------------------------------------------------
%--------------------------------------------------------
...
The maximum fitness possible in the given amount of time is around 250 and the best solution found had 233.7(\todo{i po 20 experiemntech stale plati?}).
