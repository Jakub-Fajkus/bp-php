...
/**
 * Class ThreeLegLinearExperiment1000Individuals
 * @package Experiment
 */
class ThreeLegLinearExperiment1000Individuals extends BaseExperiment
{
    /**
    ...
    {
        $executableName = 'bp_compute_primka_7_referenci_trojnozka_1000_jedincu_bez_rekombinace_turnaj_3'; //bez pocatecniho lomitka!
        ...
        for ($i = 0; $i < 60; $i++) {
            ...
            $output .= 'median fitness: ' . $individualStats->getFitnessMedian($generation->getIndividuals()) . PHP_EOL;
