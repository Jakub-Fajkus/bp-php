 ...
 * @package Experiment
 */
class ThreeLegLinearExperimentTournament3 extends BaseExperiment
{
    /**
    ...
    {
        $executableName = 'bp_compute_primka_7_referenci_trojnozka_60_jedincu_bez_rekombinace_turnaj_3'; //bez pocatecniho lomitka!
